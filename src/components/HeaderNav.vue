    ...
    <div class="header-left">
      <div class="brand">
        ...
        <div class="brand-text">
          ...
          <span class="brand-sub">{{ activeAgent === 'antigravity' ? 'Antigravity Advisor' : 'Codex Advisor' }}</span>
        </div>
      </div>

      <!-- 2-Way Agent Switcher (Codex vs Antigravity) -->
      <div class="agent-switch-group">
        <button 
          :class="['agent-tab-btn', { active: activeAgent === 'codex' }]"
          @click="$emit('change-agent', 'codex')"
          title="Switch to OpenAI Codex CLI sessions"
        >
          <span>🤖</span> Codex
        </button>
        <button 
          ...
          title="Switch to Google Antigravity sessions"
        >
